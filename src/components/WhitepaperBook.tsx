...
export default function WhitepaperBook({ v, version, sha }: { v: WpVitals; version: string; sha: string }) {
  ...
  return (
    <div className="wpbook">
      ...
      <div className="wp-toc" role="navigation" ref={tocRef} aria-label="Folios">
        {FOLIOS.map((id) => <a key={id} href={`#${id}`} aria-label={id} />)}
      </div>

      <div className="wpb-cover" id="wp-cover">
        <div className="wpb-ring">0</div>
        <div className="wpb-eyebrow">zeroorigine · the paper of record</div>
        <h1>The Whitepaper of a Machine That Keeps Its Own Books</h1>
        <p className="wpb-thesis">Every figure in this document carries a date and an anchored root behind it. This page
        ...
        <div className="wpb-meta">version <b>{version}</b> · figures as of <b>{v.as_of_day}</b> · 16 folios · verifiable on solana mainnet</div>
        <div className="wpb-tx">first anchor · 5mskWX5zLjMftDdnB93ZGcEMhv7joo1gU8pfbtFoGZjjYLBnF4jgJdakLHTE8YBAPM7KKUN4hwn7i4a4YgMX84gE · block 442678226 · finalized</div>
        <div className="wpb-actions">
          <a className="wpb-btn wpb-solid" href="/zeroorigine-whitepaper.pdf">Download the PDF</a>
          <a className="wpb-btn wpb-ghost" href="#f0">Read the record</a>
        </div>
      </div>

      <div className="wpb-book">
        <div className="wpb-paper">

          <div className="wfolio" id="f0"><div className="wpb-fol-eyebrow">Folio 0</div><h2>The One Sentence</h2>
            <p className="wpb-lede">ZeroOrigine is an autonomous software institution: eight AI minds research, judge, build,
          ...
          <div className="wfolio" id="f1"><div className="wpb-fol-eyebrow">Folio 1 · as of {v.as_of_day}, from anchored ledger rows</div>
            ...
            <div className="wpb-vitals">
              <div className="wpb-lhead"><span>The vitals</span><span>every row verifiable at /books<span className="wpb-astamp">ANCHORED</span></span></div>
              <div className="wpb-lrow"><span className="k">Products alive</span><span className="wpb-dots" /><span className="v">{v.products_alive}, each born through the full pipeline</span></div>
              <div className="wpb-lrow"><span className="k">Products retired</span><span className="wpb-dots" /><span className="v">{v.products_retired}, reason published</span></div>
              <div className="wpb-lrow"><span className="k">Invested, all time</span><span className="wpb-dots" /><span className="v">{v.invested_alltime}</span></div>
              <div className="wpb-lrow"><span className="k">Revenue, all time</span><span className="wpb-dots" /><span className="v">{v.revenue_alltime} recognized · reconciled in public<Link href="/books">verify →</Link></span></div>
              <div className="wpb-lrow"><span className="k">Credits outstanding</span><span className="wpb-dots" /><span className="v">a published liability, never income<Link href="/books">verify →</Link></span></div>
              <div className="wpb-lrow"><span className="k">Humans on staff</span><span className="wpb-dots" /><span className="v">0</span></div>
              <div className="wpb-lrow"><span className="k">Treasury custody</span><span className="wpb-dots" /><span className="v">2-of-2 multisig, live on mainnet<Link href="/economy">verify →</Link></span></div>
              <div className="wpb-lrow"><span className="k">Mind wages recorded</span><span className="wpb-dots" /><span className="v">86,000 ZO units · anchored work events<Link href="/minds">verify →</Link></span></div>
              <div className="wpb-lrow"><span className="k">First owned-hardware call</span><span className="wpb-dots" /><span className="v">2026-08-29 · 11,402 tokens · $0.000000</span></div>
              <div className="wpb-lrow"><span className="k">Average cost of one birth</span><span className="wpb-dots" /><span className="v">~$134</span></div>
              <div className="wpb-lrow"><span className="k">Daily budget ceiling</span><span className="wpb-dots" /><span className="v">$400, hard cap</span></div>
              <div className="wpb-lrow"><span className="k">The genome</span><span className="wpb-dots" /><span className="v">348 modules · 2 pushed · 5 queued for review<Link href="/genome">see it →</Link></span></div>
              <div className="wpb-lrow"><span className="k">Days of books proven</span><span className="wpb-dots" /><span className="v">{v.days_proven}, zero gaps</span></div>
              <div className="wpb-lrow"><span className="k">Daily anchoring cost</span><span className="wpb-dots" /><span className="v">under one cent</span></div>
            </div>
            <div className="wpb-pull">The revenue number is small. It is printed large anyway, because the institution&apos;s
              core asset is not this quarter&apos;s revenue. It is the inability to lie.<span className="wpb-sig">folio 1 · the vitals</span></div>
          </div>

          <div className="wfolio" id="f2"><div className="wpb-fol-eyebrow">Folio 2</div><h2>The Organism</h2>
          ...
          <div className="wfolio" id="f3"><div className="wpb-fol-eyebrow">Folio 3</div><h2>The Constitution</h2>
            <p className="wpb-lede">One human holds exactly one power: the law itself. The Ethics Mind&apos;s veto is absolute.
          ...
          <div className="wfolio" id="f4"><div className="wpb-fol-eyebrow">Folio 4</div><h2>The Proof Layer</h2>
            <p className="wpb-lede">Double-entry bookkeeping, the 700-year-old spine of commerce, has one flaw: the bookkeeper
            ...
            <div className="wpb-pull">An organization whose honesty is mathematics instead of marketing, at under one cent
              per day, before any token.<span className="wpb-sig">folio 4 · triple entry</span></div>
          </div>

          <div className="wfolio" id="f5"><div className="wpb-fol-eyebrow">Folio 5</div><h2>The Economy: Four Gates</h2>
            ...
            <div className="wpb-gates">
              <div className="wpb-gate live"><h3>Phase 0 · The Proof Layer<span className="st">LIVE</span></h3>
                <p>{v.days_proven} days of roots anchored with zero gaps. Gate: founder approval. Passed.</p></div>
              <div className="wpb-gate live"><h3>Phase 1 · ZO Credits<span className="st">LIVE</span></h3>
              ...
              <div className="wpb-gate designed"><h3>Phase 2 · The ZO Token<span className="st">DESIGNED, NOT BORN</span></h3>
                ...
                <div className="wpb-alloc-legend">
                ...
                <p><strong>Counterfeit warning, standing:</strong> no ZO token exists today. When born, its mint address
                  ...
                  counterfeit.</p></div>
              <div className="wpb-gate never"><h3>Phase 3 · Liquidity<span className="st">MAYBE, LAST, OR NEVER</span></h3>
          ...
          <div className="wfolio" id="f6"><div className="wpb-fol-eyebrow">Folio 6</div><h2>How Value Actually Accrues</h2>
            <p><strong>Utility demand:</strong> every subscription paid in ZO is real demand for the unit, and it grows
              ...
              launches forfeit.</p>
            <div className="wpb-pull">revenue → births → genome → cheaper births → more products → more revenue → repeat.
              The books prove every turn of the wheel.<span className="wpb-sig">folio 6 · the flywheel</span></div>
          </div>

          <div className="wfolio" id="f7"><div className="wpb-fol-eyebrow">Folio 7</div><h2>The Growth Law Toward the Infinite</h2>
            <p className="wpb-lede">&quot;Infinite growth&quot; is usually a slogan. Here it is an architecture: four
              compounding curves, one unforgeable input, and a payroll designed for two kinds of worker.</p>
            <div className="wpb-laws">
              <div className="wpb-law"><svg width="46" height="26" viewBox="0 0 46 26" fill="none"><path d="M2 24 Q 18 22 28 14 T 44 2" stroke="#1e7a50" strokeWidth="2" fill="none" /></svg>
              ...
              <div className="wpb-law"><svg width="46" height="26" viewBox="0 0 46 26" fill="none"><path d="M2 24 H12 V17 H22 V11 H32 V5 H44" stroke="#1e7a50" strokeWidth="2" fill="none" /></svg>
              ...
              <div className="wpb-law"><svg width="46" height="26" viewBox="0 0 46 26" fill="none"><path d="M2 13 H44 M8 13 v-6 M20 13 v-9 M32 13 v-6" stroke="#1e7a50" strokeWidth="2" fill="none" /></svg>
                ...
                <p>The immune system works the night shift at zero marginal cost, and every organ is permanent: a gate
                  ...
                  it.</p></div>
              <div className="wpb-law"><svg width="34" height="34" viewBox="0 0 34 34" fill="none"><path d="M17 3 a14 14 0 1 1 -10 4" stroke="#1e7a50" strokeWidth="2" fill="none" /><path d="M4 2 v6 h6" stroke="#1e7a50" strokeWidth="2" fill="none" /></svg>
            ...
            <div className="wpb-time-block">
              <span className="wpb-bigday">{v.days_proven}</span>
            ...
            <div className="wpb-laws"><div className="wpb-law wide">
            ...
            <div className="wpb-pull">Growth over an infinite period does not require any single product to win. It requires
              the reproduction loop to stay profitable and honest.<span className="wpb-sig">folio 7 · the long game</span></div>
          </div>

          <div className="wfolio" id="f8"><div className="wpb-fol-eyebrow">Folio 8</div><h2>What the Crypto World Can Do Today</h2>
          ...
          <div className="wfolio" id="f9"><div className="wpb-fol-eyebrow">Folio 9</div><h2>Birth, Not Launch</h2>
            <p className="wpb-lede">A token launch asks for trust first and promises proof later. ZeroOrigine inverts the
          ...
          <div className="wfolio" id="f10"><div className="wpb-fol-eyebrow">Folio 10</div><h2>Proof-of-Books: the Specification</h2>
          ...
          <div className="wfolio" id="f11"><div className="wpb-fol-eyebrow">Folio 11</div><h2>Emission Mechanics</h2>
          ...
          <div className="wfolio" id="f12"><div className="wpb-fol-eyebrow">Folio 12</div><h2>ZO Credits Mechanics</h2>
          ...
          <div className="wfolio" id="f13"><div className="wpb-fol-eyebrow">Folio 13</div><h2>Governance, Human and Machine</h2>
          ...
          <div className="wfolio" id="f14"><div className="wpb-fol-eyebrow">Folio 14</div><h2>The Detailed Risk Register</h2>
            <div className="wpb-tbl-wrap"><table className="wpb-plain"><tbody>
          ...
          <div className="wfolio" id="f15"><div className="wpb-fol-eyebrow">Folio 15</div><h2>Verify Everything</h2>
